...
<form method="post" action="<?php echo $this->uri; ?>" role="form">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2><?php $this->print_string('form_paypal_legend'); ?></h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="order_info">
                    ...
                    <?php echo $this->config->paypal_description; ?>
                </p>
                <p class="order_info_instructions"><?php $this->print_string('order_info_paypal'); ?></p>
                <p class="order_info_paylink">
                    <a href="<?php echo $this->render->paypalurl ?>"><?php $this->print_string('order_info_paypal_link'); ?></a>
                </p>
            </div>
        </div>
    </fieldset>
