...
$pageurl = new moodle_url('/local/order/user/order_cancel.php',
                          array('orderid' => $orderid,
                                'return'  => $return,
                                'confirm' => $confirm));
$PAGE->set_url($pageurl);

$PAGE->set_title(get_string('title_user_order_cancel', 'local_order'));
$PAGE->set_heading(get_string('heading_user_order_cancel', 'local_order'));

$confirmurl = new moodle_url('/local/order/user/order_cancel.php',
                          array('orderid' => $orderid,
                                'return'  => $return,
                                'confirm' => 1));
